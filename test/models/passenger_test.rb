...
describe Passenger do
  ...
  describe "custom methods" do
    describe "total cost" do
      it "can calculate the total cost for passenger" do
        passenger = Passenger.new(name: "Kari", phone_num: "111-111-1211")
        passenger.save
        new_driver = Driver.create(name: "Waldo", vin: "ALWSS52P9NEYLVDE9")
        ...
        expect(passenger.total_cost).must_equal 75.68
      end
    end
